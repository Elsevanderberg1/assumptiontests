...
export const methods: Method[] = [
  ...
  },
  {
    ...
    phase: "Understand Problem Space & Market",
    evidenceStrength: 2,
    evidenceDetail: "Evidence strength is moderate-low (2 out of 5). While you can learn a lot about unmet customer needs, the information is anecdotal and should be treated as a starting point for more experimentation. Just because the same criticism is repeated on a forum doesn't mean your assumption is validated. AI-powered sentiment analysis can help identify patterns at scale, but beware of over-interpreting noisy data.",
    descriptionShort: "Crawl information about target customers' unmet needs from discussion forums, review sites, app stores, and YouTube channels, using AI to analyze patterns at scale.",
    descriptionFull: "You can crawl a lot of information about your target customers' unmet needs by diving into discussion forums, review sites, or YouTube channels. Which source is right depends on your target audience.\n\nFor techies: Reddit or Substack. For business buyers: G2 or Capterra. For restaurant visitors: Google or Yelp.\n\nAI-powered approaches:\n- Use LLMs to analyze large volumes of reviews and forum posts. Paste batches of reviews into ChatGPT or Claude and ask it to identify recurring themes, complaints, feature requests, and workarounds.\n- AI scraping tools (Browse AI, Apify) can automate data collection from review sites and forums at scale.\n- Use sentiment analysis to categorize feedback into pain points, wishes, and praise.\n- Ask an LLM to identify the 'jobs to be done' language hidden in customer reviews.\n\nLook for:\n- A pattern of workarounds or hacks that customers are using (indicates no perfect solution exists)\n- Feature requests/complaints about existing products\n- Language customers actually use to describe their problems (crucial for messaging)\n\nTimebox yourself because it's easy to go down the rabbit hole! The information should be a starting point for more experimentation.",
    cost: "Low. AI tools make this faster than ever. Scraping tools like Browse AI have free tiers. LLM costs are minimal for review analysis.",
    costLevel: "Low",
    practicalApplication: "Scraping the internet for unmet customer needs is common practice for CRO experts, venture-building/consultants and Product Managers. With LLMs, you can now analyze hundreds of reviews in minutes, identify recurring patterns, and extract the exact language customers use to describe their problems."
  },
  {
    id: 3,
  ...
  },
  {
    ...
    phase: "Understand Problem Space & Market",
    evidenceStrength: 1,
    evidenceDetail: "Evidence strength is low (1 out of 5). As David Ogilvy said: 'People don't think what they feel, don't say what they think, and they don't do what they say.' Customer interviews are extremely valuable but findings need to be backed up by real-world tests. Self-reporting is inherently unreliable. AI can help you analyze interviews at scale but cannot fix the underlying self-reporting bias.",
    descriptionShort: "Open-ended interviews exploring target audience's pain points, challenges, jobs to be done, and willingness to pay. Use AI for transcription and cross-interview analysis.",
    descriptionFull: "An interview with open questions aimed at exploring your target audience's pain points, challenges, jobs to be done, gains, and willingness to pay. A prerequisite is knowing exactly who you want to target.\n\nRecommend 5-15 qualitative interviews before starting to build your product.\n\nKey tips:\n- Focus on the most important topics, keep it to max 30 minutes\n- This is not a chance to pitch; the goal is to learn\n- Ask if you can come back later for feedback on prototypes or beta launches\n- Note the language your interviewees use (language/market fit)\n- Ask how else they've tried solving their problem (reveals true competitors)\n\nAI-enhanced customer interviews:\n- AI transcription (Otter.ai, Fireflies.ai, Fathom, Grain) records and transcribes automatically, freeing you to be fully present in the conversation.\n- Post-interview, use an LLM to analyze transcripts: extract jobs to be done, pain points, and exact customer language.\n- Feed multiple interview transcripts into an LLM to identify patterns, contradictions, and the most common pain points across all interviews.\n- Use AI to generate a structured 'voice of customer' document with direct quotes organized by theme.\n- AI can help you identify your riskiest assumptions to test in subsequent interviews.\n\nDo NOT use AI to conduct the interviews themselves. The human connection, follow-up questions, and reading of body language/tone are irreplaceable.",
    cost: "Low. Interviewees rarely need compensation. AI transcription tools: free to $30/mo.",
    costLevel: "Low",
    practicalApplication: "Most startups do at least 10-15 customer interviews. Use AI transcription tools to capture every word, then feed all transcripts into an LLM to identify the top 3-5 recurring pain points and the exact language customers use. This language becomes your marketing copy."
  },
  {
    id: 9,
