...
export const methods: Method[] = [
  ...
  },
  {
    ...
    descriptionShort: "Observe target customers in their natural environment to uncover hidden needs that interviews miss. Ethnography finds the workarounds, routines, and frustrations people no longer consciously notice. This allows us to uncover hidden needs.",
